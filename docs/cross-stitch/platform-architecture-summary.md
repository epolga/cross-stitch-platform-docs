...
| Elastic Beanstalk env name `cross-stitch-com-env` — Uploader can restart it; documented in cross-stitch `ENVIRONMENT-SETUP.md` | both-observed | `d:/ann/Git/Uploader/Uploader/Helpers/ElasticBeanstalkHelper.cs`, `d:/ann/Git/Uploader/Uploader/App.config`, `d:/ann/Git/cross-stitch/ENVIRONMENT-SETUP.md` |
...
| **AWS Elastic Beanstalk** | Uploader (restart `cross-stitch-com-env`); cross-stitch (deployment target) | `d:/ann/Git/Uploader/Uploader/Helpers/ElasticBeanstalkHelper.cs`; `d:/ann/Git/cross-stitch/.ebextensions/`, `d:/ann/Git/cross-stitch/.elasticbeanstalk/config.yml` | `d:/ann/Git/cross-stitch/ENVIRONMENT-SETUP.md` (sibling repo, redirect-stub in docs hub at `plan/cross-stitch/ENVIRONMENT-SETUP.md`) |
...
- **EB env rename has no compile-time signal** — Uploader can restart `cross-stitch-com-env`; renaming on the cross-stitch side would silently break the Uploader button (`d:/ann/Git/Uploader/Uploader/Helpers/ElasticBeanstalkHelper.cs`).
...
| **AWS deployment assumptions** | yes — bucket name `cross-stitch-designs`, sitemap bucket `cross-stitch-sitemap-cache`, CloudFront `d2o1uvvg91z7o4.cloudfront.net`, EB env `cross-stitch-com-env`, EB app `cross-stitch-com`, region `us-east-1` (`d:/ann/Git/Uploader/Uploader/App.config`, `d:/ann/Git/cross-stitch/.elasticbeanstalk/config.yml`, `d:/ann/Git/cross-stitch/next.config.js`) | partially — `plan/integration-aws/README.md` is a proposal-only README |
